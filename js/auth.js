  ...
  try {
    ...
    if (usuario.rol === "Admin") {
      ...
      newButton.addEventListener("click", () => {
        window.location.href = currentPage === "index.html" ? "Foodie_Rank/html/admin.html" : "../Foodie_Rank/html/admin.html";
      });
    } else {
      newButton.textContent = "Mi perfil";
      newButton.classList.add("boton-dinamico")
      newButton.addEventListener("click", () => {
        window.location.href = currentPage === "index.html" ? "Foodie_Rank/html/perfil_user.html" : "../Foodie_Rank/html/perfil_user.html";
      });
    }
